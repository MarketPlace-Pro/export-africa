...
class CartProductGenerator {
  generateEnhancedProductCard() {
...
`;
    ...
    // Save the enhanced component
    const filePath = path.join('./src/components', 'ProductCard.js');
    fs.writeFileSync(filePath, componentCode);
    console.log('✅ Enhanced ProductCard with cart functionality generated!');
...
const generator = new CartProductGenerator();
generator.generateEnhancedProductCard();
